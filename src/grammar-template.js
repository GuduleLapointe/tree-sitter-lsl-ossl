module.exports = grammar({
	...
	rules: {
		...
		constant: ($) => choice(), // CONSTANTS_PLACEHOLDER

		// -----------------
		// LSL built-in functions (ll* prefix)
		// -----------------
		lsl_function: ($) => choice(), // LSL_FUNCTIONS_PLACEHOLDER

		// -----------------
		// OSSL built-in functions (os* prefix)
		// -----------------
		ossl_function: ($) => choice(), // OSSL_FUNCTIONS_PLACEHOLDER

		event_handler: ($) =>
			seq($.event_name, "(", optional($.parameter_list), ")", $.block),

		event_name: ($) => choice(), // EVENT_NAMES_PLACEHOLDER
